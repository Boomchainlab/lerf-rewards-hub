...
import { ClientOptions } from 'earn-app';
...
export { ClientOptions } from 'earn-app';
...
export function initMcpServer(params: {
  ...
  const client = new EarnApp(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client ||
    new EarnApp({
      environment: (readEnv('EARN_APP_ENVIRONMENT') || undefined) as any,
